...
int main(int argc, char **argv){
    ...
    if (4 > argc or argc > 6) {
     ...
     "usage: enter rgb and width");
  	return 1;
  }

    std::shared_ptr<rclcpp::Node> node = rclcpp::Node::make_shared("set_pen_client");
    
    rclcpp::Client<turtlesim::srv::SetPen>SharedPtr client = node->create_client<turtlesim::srv::SetPen>("turtlesim/SetPen/Request");
